  ...
  public static evaluateCandidates(
    ...
    for (const [groupKey, groupCandidates] of clusterGroups.entries()) {
      ...
      const rankedInCluster = [...groupCandidates].sort((a, b) => {
        const scoreA = (a.score || 70) + (a.relativeStrengthScore ? (a.relativeStrengthScore - 50) * 0.1 : 0);
        const scoreB = (b.score || 70) + (b.relativeStrengthScore ? (b.relativeStrengthScore - 50) * 0.1 : 0);
